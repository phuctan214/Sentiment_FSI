...
def predict():
    if request.method == 'POST':
        ...
        json_type = {'total_message':total_message, 'positive_comment': word_count(positive_comment),
                    'neutral_comment':word_count(neutral_comment), 'negative_comment':word_count(negative_comment)
                    }
